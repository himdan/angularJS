...
App.factory('Video', function($q, $http) {
    ...
    factory.findInYouTube = function(search_by, keyword, offset) {
        ...
        if(search_by == "user") {
            return factory.findByUser(keyword, offset);
        } else if(search_by == 'channel') {
            return factory.findByChannel(keyword, offset);
        } else {
            return factory.findBySearch(keyword, offset);
        }
